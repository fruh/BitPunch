...
// universal
#define param_max_iter 10 ///< maximum count of iterations in decoding

// decode1 alg
#define param_delta 5 ///< starting param delta (threshold) for decode1 algorithm

// decode2 alg
#define param_delta_B 0 ///< threshold for decode2 
#define max_b_values 5 ///< count of precalculated values for decode2 algorithm 
extern const uint16_t B_store[max_b_values];
