...
#endif
#ifdef ATTACK_ON_ELP
	fprintf(stdout, "Attack on Error Locator Polynomial\n\n");
#endif
#ifdef ATTACK_ON_PATTERSON
	fprintf(stdout, "Attack on Patterson algorith\n\n");
#endif
#ifdef ATTACK_ON_PERMUTATION
	fprintf(stdout, "Attack on Secret Permutation\n\n");
#endif
#ifdef ATTACK_ON_INVERSION
	fprintf(stdout, "Attack on Syndrome Inversion\n\n");
#endif
